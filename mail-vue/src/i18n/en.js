const en = {
    ...
    save: 'Save',
    profile: 'Profile',
    defaultSendingEmail: 'Default sending email',
    mailtoHandler: 'Email link handling',
    mailtoHandlerDesc: 'Register Cloud Mail to handle mailto: links. You must still select Cloud Mail in Windows Default Apps.',
    registerMailtoHandler: 'Register Cloud Mail for email links',
    openWindowsDefaultApps: 'Open Windows Default Apps',
    mailtoHandlerUnsupported: 'This browser cannot register email link handlers. Use the latest Chrome or the installed Cloud Mail PWA.',
    mailtoRegistrationRequested: 'Registration requested. Accept the browser prompt, then choose Cloud Mail as the Windows MAILTO default.',
    mailtoRegistrationFailed: 'Registration failed. Confirm the page uses HTTPS and open it in the latest Chrome or the Cloud Mail PWA.',
    newMailNotifications: 'New mail notifications',
    newMailNotificationsDesc: 'Refreshes mail in real time while Cloud Mail runs. On Web Push capable devices, system notifications continue after the PWA is closed.',
    desktopNotificationsUnsupported: 'Desktop notifications are not supported in this browser. In-app notifications remain available.',
    desktopNotificationsGranted: 'Windows desktop notifications are allowed.',
    desktopNotificationsDenied: 'Windows desktop notifications were denied. In-app notifications remain enabled.',
    desktopNotificationsNotRequested: 'Enabling this will request system notification permission on this device.',
    pushNotificationsUnsupported: 'Background push is unavailable here. On mobile, install Cloud Mail to the Home Screen and enable it again. In-app alerts still work while running.',
    pushNotificationsActive: 'Background new-mail push is enabled on this device.',
    pushNotificationsReady: 'Notification permission is allowed, but the background subscription is incomplete. Enable it again.',
    pushNotificationsSetupFailed: 'Background push setup failed. Real-time refresh still works while Cloud Mail is running.',
    mailtoOpenFailed: 'Unable to open composer',
    mailtoAdminRequired: 'This account cannot send as {email}. Sign in with the administrator account.',
    mailtoInvalidUri: 'The email link is invalid.',
    mailtoDraftConflict: 'An unfinished message is open. Save it as a draft and open the new email link?',
    mailtoSaveAndOpen: 'Save and open',
    mailtoDraftSaveFailed: 'The draft could not be saved. The original message was kept and the new email link was not opened.',
    mailtoWaitingForSend: 'The current message is still sending. The new email link will open when it finishes.',
    mailtoWarningTitle: 'Some email link content was not imported',
    mailtoUnsupportedParameter: 'Parameter {parameter} is not supported yet',
    mailtoInvalidRecipient: 'Ignored invalid recipient {recipient}',
    mailtoSubjectTruncated: 'The subject was too long and was truncated',
    mailtoBodyTruncated: 'The body was too long and was truncated',
    mailtoUriTruncated: 'The email link was too long and was truncated',
    newMailNotificationTitle: 'New email received',
    newMailNotificationCount: '{count} new emails received',
    newMailNotificationSummary: '{count} new emails arrived across visible mailboxes',
    change: 'Change',
    changePwdBtn: 'Change',
    username: 'Username',
    password: 'Password',
