const zh = {
    ...
    save: '保存',
    profile: '个人信息',
    defaultSendingEmail: '默认发送邮箱',
    mailtoHandler: '邮件链接处理',
    mailtoHandlerDesc: '注册 Cloud Mail 处理 mailto: 链接。注册后仍需在 Windows 默认应用中选择 Cloud Mail。',
    registerMailtoHandler: '注册 Cloud Mail 处理邮件链接',
    openWindowsDefaultApps: '打开 Windows 默认应用设置',
    mailtoHandlerUnsupported: '当前浏览器不支持注册邮件链接处理程序，请使用最新版 Chrome 或已安装的 Cloud Mail PWA。',
    mailtoRegistrationRequested: '已请求注册。请接受浏览器提示，然后在 Windows 的 MAILTO 默认应用中选择 Cloud Mail。',
    mailtoRegistrationFailed: '注册失败。请确认当前页面使用 HTTPS，并通过最新版 Chrome 或 Cloud Mail PWA 打开。',
    newMailNotifications: '新邮件提醒',
    newMailNotificationsDesc: 'Cloud Mail 运行时实时刷新；设备支持 Web Push 时，完全关闭 PWA 后仍会显示系统通知。',
    desktopNotificationsUnsupported: '当前浏览器不支持 Windows 桌面通知；站内提醒仍可使用。',
    desktopNotificationsGranted: 'Windows 桌面通知已授权。',
    desktopNotificationsDenied: 'Windows 桌面通知已被拒绝；仍会显示站内提醒。',
    desktopNotificationsNotRequested: '开启后将请求此设备的系统通知权限。',
    pushNotificationsUnsupported: '当前环境不支持后台推送。手机端请将 Cloud Mail 安装到主屏幕后再开启；运行时站内提醒仍可使用。',
    pushNotificationsActive: '后台新邮件推送已在此设备启用。',
    pushNotificationsReady: '通知权限已允许，但后台推送尚未完成订阅；请重新开启一次。',
    pushNotificationsSetupFailed: '后台推送配置失败；运行时实时刷新仍然有效。',
    mailtoOpenFailed: '无法打开写信窗口',
    mailtoAdminRequired: '当前账号无权使用 {email} 发信，请登录管理员账号。',
    mailtoInvalidUri: '邮件链接无效。',
    mailtoDraftConflict: '当前有未完成邮件。是否保存为草稿并打开新的邮件链接？',
    mailtoSaveAndOpen: '保存并打开',
    mailtoDraftSaveFailed: '草稿保存失败，原邮件已保留，未打开新的邮件链接。',
    mailtoWaitingForSend: '正在发送上一封邮件，发送完成后将打开新的邮件链接。',
    mailtoWarningTitle: '邮件链接部分内容未导入',
    mailtoUnsupportedParameter: '暂不支持参数 {parameter}',
    mailtoInvalidRecipient: '已忽略无效收件人 {recipient}',
    mailtoSubjectTruncated: '主题过长，已截断',
    mailtoBodyTruncated: '正文过长，已截断',
    mailtoUriTruncated: '邮件链接过长，已截断',
    newMailNotificationTitle: '收到新邮件',
    newMailNotificationCount: '收到 {count} 封新邮件',
    newMailNotificationSummary: '全部可见邮箱共收到 {count} 封新邮件',
    change: '修改',
    changePwdBtn: '修改密码',
    username: '用户名',
    password: '密码',
